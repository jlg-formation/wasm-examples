(module
 ...
 (data $13 (i32.const 720) "\06\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00 \00\00\00\01\t\00\00")
 (table $0 1 1 funcref)
 (elem $0 (i32.const 1))
 (export "createAndUseCounter" (func $assembly/index/createAndUseCounter))
 (export "createPinnedCounter" (func $assembly/index/createPinnedCounter))
 (export "forceGC" (func $assembly/index/forceGC))
 ...
 (start $~start)
 (func $assembly/index/Counter#set:count (param $this i32) (param $count i32)
  local.get $this
  local.get $count
  i32.store
 )
 ...
 (func $assembly/index/Counter#get:count (param $this i32) (result i32)
  local.get $this
  i32.load
 )
      ...
      block $~lib/string/String
       block $~lib/arraybuffer/ArrayBuffer
        block $~lib/object/Object
         ...
         i32.sub
         i32.load
         br_table $~lib/object/Object $~lib/arraybuffer/ArrayBuffer $~lib/string/String $~lib/arraybuffer/ArrayBufferView $assembly/index/Counter $~lib/typedarray/Int32Array $invalid
        end
        return
       end
       return
 ...
 (func $assembly/index/Counter#constructor (param $this i32) (param $initial i32) (result i32)
  (local $2 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 8
  i32.sub
  ...
  local.get $2
  i32.const 0
  call $assembly/index/Counter#set:count
  local.get $this
  local.set $2
  global.get $~lib/memory/__stack_pointer
  local.get $2
 ...
 (func $assembly/index/Counter#increment (param $this i32) (result i32)
  (local $1 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 8
  i32.sub
  ...
  i32.store offset=4
  local.get $1
  call $assembly/index/Counter#get:count
  i32.const 1
  i32.add
  call $assembly/index/Counter#set:count
  local.get $this
 ...
 (func $assembly/index/Counter#getValue (param $this i32) (result i32)
  (local $1 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
 ...
 (func $assembly/index/createAndUseCounter (param $initial i32) (result i32)
  (local $counter i32)
  (local $2 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 8
  ...
  i32.const 0
  local.get $initial
  call $assembly/index/Counter#constructor
  local.tee $counter
  i32.store
  local.get $counter
  local.set $2
  ...
  i32.store offset=4
  local.get $2
  call $assembly/index/Counter#increment
  drop
  local.get $counter
  local.set $2
  global.get $~lib/memory/__stack_pointer
  ...
  i32.store offset=4
  local.get $2
  call $assembly/index/Counter#getValue
  local.set $2
  global.get $~lib/memory/__stack_pointer
  i32.const 8
  i32.add
 ...
 (func $assembly/index/createArray (param $size i32) (result i32)
  (local $arr i32)
  (local $i i32)
  (local $3 i32)
  global.get $~lib/memory/__stack_pointer
 ...
 (func $assembly/index/sumArray (param $arr i32) (result i32)
  (local $sum i32)
  (local $i i32)
  (local $3 i32)
  global.get $~lib/memory/__stack_pointer
 ...
 (func $assembly/index/createPinnedCounter (param $initial i32) (result i32)
  (local $counter i32)
  (local $2 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
