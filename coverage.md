# Couverture des instructions WebAssembly dans `01-wat`

## Perimetre

Cette analyse couvre tous les fichiers `01-wat/**/*.wat` du depot.
...
- Nombre d'instructions jamais utilisees dans `01-wat` : **482**
