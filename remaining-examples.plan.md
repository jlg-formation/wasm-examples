...
| 11  | wat_q11 | Extension VS Code            | ❌        | -                                   | `docs/03-vscode-extensions.md` |
...
| 17  | wat_q17 | Variable locale              | ⚠️        | `01-wat/07-loop/loop.wat`           | `01-wat/16-locals/`            |
...
**Résumé Chapitre 2:** 18/20 couverts (90%)
...
| 6   | runtime_q6  | instantiateStreaming          | ❌        | -                              | `01-wat/16-streaming/`      |
| 7   | runtime_q7  | Partage mémoire JS/WASM       | ✅        | `01-wat/05-memory/wrapper.mjs` | -                           |
| 8   | runtime_q8  | Wasm3 (IoT)                   | ❌        | -                              | `docs/01-wasm-runtimes.md`  |
| 9   | runtime_q9  | WASI filesystem               | ✅        | `03-wasi/01-hello/`            | -                           |
| 10  | runtime_q10 | Gestion erreurs               | ❌        | -                              | `01-wat/16-error-handling/` |
| 11  | runtime_q11 | memory.buffer                 | ✅        | `01-wat/05-memory/wrapper.mjs` | -                           |
| 12  | runtime_q12 | memory.grow()                 | ❌        | -                              | `01-wat/16-memory-grow/`    |
| 13  | runtime_q13 | importObject                  | ✅        | `01-wat/02-import/wrapper.mjs` | -                           |
| 14  | runtime_q14 | Passer string à WASM          | ❌        | -                              | `01-wat/16-strings/`        |
| 15  | runtime_q15 | WebAssembly.validate()        | ❌        | -                              | `01-wat/16-validate/`       |
| 16  | runtime_q16 | WebAssembly.Table()           | ✅        | `01-wat/11-table/wrapper.mjs`  | -                           |
| 17  | runtime_q17 | instantiateStreaming avantage | ❌        | -                              | `01-wat/16-streaming/`      |
| 18  | runtime_q18 | BigInt pour i64               | ❌        | -                              | `01-wat/16-bigint/`         |
| 19  | runtime_q19 | Wasmer                        | ❌        | -                              | `docs/01-wasm-runtimes.md`  |
| 20  | runtime_q20 | Vérifier support WASM         | ❌        | -                              | `01-wat/16-feature-detect/` |

**Résumé Chapitre 3:** 10/20 couverts (50%)
...
| 9   | as_q9  | Source maps debug           | ❌        | -                                   | `docs/03-assemblyscript-debug.md` |
| 10  | as_q10 | Option --optimize           | ❌        | -                                   | `04-assemblyscript/04-optimize/`  |
| 11  | as_q11 | \_\_newString() loader      | ❌        | -                                   | `04-assemblyscript/04-strings/`   |
| 12  | as_q12 | Debug vs Release            | ✅        | `04-assemblyscript/*/build/`        | -                                 |
| 13  | as_q13 | \_\_getString() loader      | ❌        | -                                   | `04-assemblyscript/04-strings/`   |
| 14  | as_q14 | Tableau typé Int32Array     | ❌        | -                                   | `04-assemblyscript/04-arrays/`    |
| 15  | as_q15 | \_\_release()               | ❌        | -                                   | `04-assemblyscript/04-gc/`        |
| 16  | as_q16 | @external import            | ❌        | -                                   | `04-assemblyscript/04-imports/`   |
| 17  | as_q17 | StaticArray vs Array        | ❌        | -                                   | `04-assemblyscript/04-arrays/`    |
| 18  | as_q18 | Support SIMD v128           | ❌        | -                                   | `04-assemblyscript/04-simd/`      |
| 19  | as_q19 | assert() et abort()         | ❌        | -                                   | `04-assemblyscript/04-errors/`    |
| 20  | as_q20 | Analyse taille module       | ❌        | -                                   | `docs/03-wasm-analysis-tools.md`  |
...
| 4   | em_q4  | Installation Emscripten     | ❌        | -                                     | `docs/02-emscripten-install.md`   |
...
| 9   | em_q9  | asm.js historique           | ❌        | -                                     | `docs/01-asmjs-history.md`        |
...
| 13  | em_q13 | HEAP8/HEAP32/HEAPF64        | ❌        | -                                     | `02-emscripten/08-heap/`          |
| 14  | em_q14 | -sALLOW_MEMORY_GROWTH       | ❌        | -                                     | `02-emscripten/08-memory-growth/` |
| 15  | em_q15 | Debug -gsource-map          | ❌        | -                                     | `02-emscripten/08-debug/`         |
...
| 18  | em_q18 | Lier plusieurs fichiers C   | ❌        | -                                     | `02-emscripten/08-multifile/`     |
| 19  | em_q19 | Ports bibliothèques tierces | ❌        | -                                     | `02-emscripten/08-ports/`         |
| 20  | em_q20 | -o .js vs -o .html          | ❌        | -                                     | `02-emscripten/08-html-output/`   |
...
| #   | ID       | Question QCM                   | Couvert ? | Exemple existant                    | Exemple à créer                       |
| --- | -------- | ------------------------------ | --------- | ----------------------------------- | ------------------------------------- |
| 1   | port_q1  | emconfigure                    | ❌        | -                                   | `02-emscripten/08-autoconf/`          |
| 2   | port_q2  | emmake make                    | ❌        | -                                   | `02-emscripten/08-makefile/`          |
| 3   | port_q3  | -sMODULARIZE                   | ⚠️        | `02-emscripten/03-es6/Makefile`     | `02-emscripten/08-modularize/`        |
...
| 7   | port_q7  | Variable EMSDK                 | ❌        | -                                   | `docs/02-emscripten-install.md`       |
| 8   | port_q8  | Autoconf/Automake              | ❌        | -                                   | `02-emscripten/08-autoconf/`          |
| 9   | port_q9  | EXPORTED_RUNTIME_METHODS       | ⚠️        | `02-emscripten/02-library/Makefile` | -                                     |
| 10  | port_q10 | emcmake cmake                  | ❌        | -                                   | `02-emscripten/08-cmake/`             |
| 11  | port_q11 | --embed-file vs --preload-file | ⚠️        | `02-emscripten/07-filesystem/`      | -                                     |
| 12  | port_q12 | IDBFS persistance              | ❌        | -                                   | `02-emscripten/08-idbfs/`             |
| 13  | port_q13 | -sINITIAL_MEMORY               | ❌        | -                                   | `02-emscripten/08-memory-config/`     |
| 14  | port_q14 | Symboles non définis           | ❌        | -                                   | `02-emscripten/08-undefined-symbols/` |
| 15  | port_q15 | -sWASM_BIGINT                  | ❌        | -                                   | `02-emscripten/08-bigint/`            |
| 16  | port_q16 | Debug librairie portée         | ❌        | -                                   | `02-emscripten/08-debug/`             |
| 17  | port_q17 | -sSINGLE_FILE=1                | ❌        | -                                   | `02-emscripten/08-single-file/`       |
| 18  | port_q18 | Module.arguments               | ✅        | `02-emscripten/05-main/`            | -                                     |
| 19  | port_q19 | -sINVOKE_RUN=0                 | ❌        | -                                   | `02-emscripten/08-no-main/`           |
| 20  | port_q20 | Intégration React/Vue          | ❌        | -                                   | `02-emscripten/08-spa-integration/`   |
...
| -------------------- | -------- | ------- | ----------- |
| 1. Introduction WASM | 9        | 20      | 45%         |
| 2. Langage WAT       | 18       | 20      | 90%         |
| 3. Runtimes & API JS | 10       | 20      | 50%         |
...
1. **`01-wat/16-strings/`** - Passage de chaînes de caractères entre JS et WASM
2. **`01-wat/16-memory-grow/`** - Croissance dynamique de la mémoire
3. **`01-wat/16-streaming/`** - Utilisation de `instantiateStreaming`
4. **`01-wat/16-error-handling/`** - Gestion des erreurs CompileError/LinkError/RuntimeError
5. **`01-wat/16-bigint/`** - Utilisation des BigInt pour i64

### Moyenne priorité (AssemblyScript)

6. **`04-assemblyscript/04-strings/`** - **newString/**getString avec le loader
7. **`04-assemblyscript/04-imports/`** - @external pour importer des fonctions JS
8. **`04-assemblyscript/04-arrays/`** - StaticArray et Int32Array
9. **`04-assemblyscript/04-gc/`** - Garbage collector et \_\_release

### Moyenne priorité (Emscripten avancé)

10. **`02-emscripten/08-modularize/`** - -sMODULARIZE avec factory Promise
11. **`02-emscripten/08-cmake/`** - emcmake pour projets CMake
12. **`02-emscripten/08-optimize/`** - Comparaison -O0 à -O3
13. **`02-emscripten/08-heap/`** - Accès HEAP8/HEAP32/HEAPF64

### Basse priorité (cas avancés)

14. **`02-emscripten/08-autoconf/`** - emconfigure pour projets Autoconf
15. **`02-emscripten/08-idbfs/`** - Persistance avec IndexedDB
16. **`02-emscripten/08-spa-integration/`** - Intégration React/Vue
17. **`04-assemblyscript/04-simd/`** - Opérations SIMD v128
